function getValue(){
    ...
    var num18 = document.getElementById("pc-4").value;
    var num19 = document.getElementById("eng-1").value;
    var num20 = document.getElementById("eng-2").value;
    var num21 = document.getElementById("eng-3").value;
    var num22 = document.getElementById("ar-1").value;
    var num23 = document.getElementById("ar-2").value;
    var num24 = document.getElementById("ar-3").value;
    var num25 = document.getElementById("fr-1").value;
    var num26 = document.getElementById("fr-2").value;
    var num27 = document.getElementById("fr-3").value;
    var num28 = document.getElementById("fr-4").value;
    var num29 = document.getElementById("fr-5").value;
    var num30 = document.getElementById("svt-1").value;
    var num31 = document.getElementById("svt-2").value;
    var num32 = document.getElementById("svt-3").value;
var num1a1 = (parseInt(num1))*1;
var num1a2 = ((parseInt(num2) + parseInt(num3) + parseInt(num4))/3)*2 ;
var num1a3 = ((parseInt(num5) + parseInt(num6) + parseInt(num7) + parseInt(num8))/4)*4;
var num1a4 = ((parseInt(num9) + parseInt(num10) + parseInt(num11))/3)*7;
var num1a5 = ((parseInt(num12) + parseInt(num13) + parseInt(num14))/3)*2;
var num1a6 = ((parseInt(num15) + parseInt(num16) + parseInt(num17) + parseInt(num18))/4)*7;
var num1a7 = ((parseInt(num19) + parseInt(num20) + parseInt(num21))/3)*2;
var num1a8 = ((parseInt(num22) + parseInt(num23) + parseInt(num24))/3)*2;
var num1a9 = ((parseInt(num25) + parseInt(num26) + parseInt(num27) + parseInt(num28) + parseInt(num29))/5)*4;
var num1a10 = ((parseInt(num30) +parseInt(num31) + parseInt(num32))/3)*5;
